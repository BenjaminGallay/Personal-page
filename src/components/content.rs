...
pub fn content(properties: &Properties) -> Html {
    match properties.selected_page {
        0 => html! {
            <div class="whoami unpressed">
                if properties.lang == 0 {
                    <p>{"My name is Benjamin Gallay, and I am currently starting my studies in the Grande Ecole Centrale Supélec, in order to study computer science."}</p>
                } else {
        ...
        2 => html! {
            <div class="projects">
            <a class="project" tabindex="0" href="https://www.archwiki.org">
                <h3>{"Stupid Project"}</h3>
                <p>{"this is a short description of an awkward project that no one is ever gonna read or use, and that is soon gonna fall in a pit of uncaring oblivion and embarrassement"}</p>
            </a>
            <a class="project" tabindex="0" href="https://www.archwiki.org">
                <h3>{"Stupid Project"}</h3>
                <p>{"this is a short description of an awkward project that no one is ever gonna read or use, and that is soon gonna fall in a pit of uncaring oblivion and embarrassement"}</p>
